    ...
    <div class="card shadow-lg border-0 rounded-lg my-5">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('user') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="departement_id" class="form-label">Choose Departement</label>
                    <select class="form-select form-control" name="departement_id">
                        <option selected>Open this select menu</option>
                        @foreach ($departement as $departements)
                            <option id="departement_id" value="{{$departements->id}}">{{$departements->name}}</option>
                        @endforeach
